...
AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: AppComponent, selectors: [["app-root"]], decls: 53, vars: 0, consts: [["name", "viewport", "content", "width=device-width,initial-scale=1"], ["id", "head1"], ["id", "head2"], ["id", "google"], ["href", "https://www.gmail.com"], ["id", "googlee", "type", "button", 1, "btn", "btn-primary", "btn-lg"], [1, "fa", "fa-google"], ["id", "faceboook"], ["href", "https://www.facebook.com"], ["id", "facebook", "type", "button", 1, "btn", "btn-primary", "btn-lg"], [1, "fa", "fa-facebook"], ["id", "o"], [1, "form-group", "input-group"], [1, "dekha"], ["id", "user", 1, "fa", "fa-user"], ["id", "fname", "type", "text", "name", "Fname", "placeholder", "   Full name"], [1, "jak"], ["id", "email", 1, "fa", "fa-envelope"], ["id", "mail", "type", "text", "name", "email", "placeholder", "   Email Address"], ["id", "phone", 1, "fa", "fa-phone"], ["id", "Ph-number", "type", "text", "name", "phone", "placeholder", "   Phone Number"], ["id", "pass", 1, "fa", "fa-lock"], ["id", "Password", "type", "password", "name", "pass", "placeholder", "   Create Password"], ["id", "rpass", 1, "fa", "fa-lock"], ["id", "RePassword", "type", "password", "name", "rpass", "placeholder", "   Repeat Password"], [1, "lastbutton"], ["id", "cacc", "type", "submit", 1, "btn", "btn-primary", "btn-lg"], [1, "lasttext"], ["id", "lt"], ["href", "#"]], template: function AppComponent_Template(rf, ctx) { if (rf & 1) {
...
module.exports = __webpack_require__(/*! C:\Users\Kamal\Desktop\login2\logiiin\src\main.ts */"./src/main.ts");
